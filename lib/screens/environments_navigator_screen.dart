...
class EnvironmentsNavigatorScreen extends StatefulWidget {
  const EnvironmentsNavigatorScreen({super.key});

  @override
  State<EnvironmentsNavigatorScreen> createState() =>
      _EnvironmentsNavigatorScreenState();
}

enum SearchType { environmentName, username }

class _EnvironmentsNavigatorScreenState
    extends State<EnvironmentsNavigatorScreen> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => HomeNavigatorScreen.pageController
                          .jumpToPage(
                              HomeNavigatorScreen.addEnvironmentPageIndex),
                    )
                  ],
                ),
              ),
